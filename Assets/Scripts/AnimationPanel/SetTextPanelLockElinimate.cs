...
public class SetTextPanelLockElinimate : SetTextPanel
{
    public override void SetText()
    {
        ...
        else
        {
            ...
            texts[0].color = CellColor.Instance.GetTextColor((BigInteger)Mathf.Pow(2, GridManager.Instance.MinIndex - 2));
        }
        ...
        texts[1].color = CellColor.Instance.GetTextColor((BigInteger)Mathf.Pow(2, GridManager.Instance.MinIndex - 1));
        ...
        texts[2].color = CellColor.Instance.GetTextColor((BigInteger)Mathf.Pow(2, GridManager.Instance.MinIndex));
