...
public class SetTextBlockAdded : SetTextPanel
{
    public override void SetText()
    {
        ...
        texts[0].color = CellColor.Instance.GetTextColor((BigInteger)Mathf.Pow(2, GridManager.Instance.MaxIndexRandom - 1));
        ...
        texts[1].color = CellColor.Instance.GetTextColor((BigInteger)Mathf.Pow(2, GridManager.Instance.MaxIndexRandom ));
        ...
        texts[2].color = CellColor.Instance.GetTextColor((BigInteger)Mathf.Pow(2, GridManager.Instance.MaxIndexRandom + 1));
